    ...
    <div class="row">
       <div class="col-md-12">
         <div class="box box-info">
           ...
           <ol class="breadcrumb">
                      <li><a href="<?= base_url('tratamientos/panel/nuevo') ?>"><i class="fa fa-refresh"></i> Actualizar</a></li>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="asunto" class="form-control input-sm" placeholder="Asunto">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="control-label">Obsevación</label>
                    <input type="text" name="observacion" class="form-control input-sm" placeholder="Observación">
                  </div>
                </div>
              </div>
            </div>
