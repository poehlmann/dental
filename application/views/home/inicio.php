...
<head>
  ...
  <title>Odonto Martinez | Cuenta</title>
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="<?= base_url() ?>assets/img/adminsistemas.jpg" alt="user image">
                        <span class="username">
                          <a>Sistema Web Odontologico</a>
                         
                        </span>
                    <span class="description">Administrador del Sistema</span>
                  </div>
                  <!-- /.user-block -->
                  <p>
                    Bienvenido al sistema odontologico desarrollado para clínicas y consultorios odontológicos con el objetivo de sistematizar sus procesos en registro de citas,pagos de tratamientos, historia clínica y odontograma virtual.
                  </p>
